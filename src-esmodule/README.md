result of `yarn babel src-esmodule`:
...
[/usr/local/google/home/cjamcl/code/scratch/babel-esmodule-preset/src-esmodule/main.js] Replaced @babel/polyfill entries with the following polyfills:
